...
from digital_twin_files.coupled_rom_w_kinetics.digital_twin_driver import PRKEMicroStepper, thermal_default_params
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=HERE / "short_kinetics_animation.gif")
