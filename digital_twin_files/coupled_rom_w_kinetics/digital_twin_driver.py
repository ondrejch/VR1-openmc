...
def save_summary_plot(
    ...
    parameter_schedule: np.ndarray,
    output_path: str | Path = HERE / "coupled_digital_twin_summary.png",
    z_index: int = 35,
) -> None:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=HERE / "coupled_digital_twin_results.npz", help="Output NPZ path.")
    parser.add_argument("--plot-output", type=Path, default=HERE / "coupled_digital_twin_summary.png", help="Output summary figure path.")
