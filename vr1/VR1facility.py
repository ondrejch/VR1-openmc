...
class Facility:
    ...
    def build(self, lattice = None):  # Kept optional to support an empty facility model.
        ...
        self.cells["V2.3"]      = openmc.Cell(name="V2.3",      fill = self.materials.air,         region=-self.surfaces["RCcy.4"] & +self.surfaces["RCcy.5"] & +self.surfaces["RCpy.5"])
        ...
        self.cells["V1.2"]      = openmc.Cell(name="V1.2",      fill = self.materials.air,         region=-self.surfaces["RCcy.7"] & +self.surfaces["RCpy.7"])
        ...
        self.cells["V1.5"]      = openmc.Cell(name="V1.5",      fill = self.materials.air,         region=-self.surfaces["RCcy.4"] & -self.surfaces["RCpy.7"] & +self.surfaces["RCpy.8"])
